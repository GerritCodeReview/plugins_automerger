...
public class ConfigLoaderIT extends PluginDaemonTest {
  ...
  public void setUp() throws Exception {
    ...
    projectMock = createMock(Projects.class);
    projectApiMock = createMock(ProjectApi.class);
    branchApiMock = createMock(BranchApi.class);
    configBinaryResultMock = createMock(BinaryResult.class);
    binaryResultMock = createMock(BinaryResult.class);
