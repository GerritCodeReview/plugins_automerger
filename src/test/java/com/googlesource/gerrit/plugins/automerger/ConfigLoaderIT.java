...
public class ConfigLoaderIT extends PluginDaemonTest {
  ...
  public void setUp() throws Exception {
    ...
    String configFilePath = Paths.get(".", "plugins", "automerger", "src", "test",
        "resources", "com", "googlesource", "gerrit", "plugins", "automerger",
        "config.yaml").toAbsolutePath().normalize().toString();
    ...
    String firstDownstreamManifestPath = Paths.get(".", "plugins", "automerger", "src", "test",
        "resources", "com", "googlesource", "gerrit", "plugins", "automerger",
    ...
    String secondDownstreamManifestPath = Paths.get(".", "plugins", "automerger", "src", "test",
        "resources", "com", "googlesource", "gerrit", "plugins", "automerger",
  ...
  private void loadMockConfig() throws Exception {
    ...
    expect(branchApiMock.file("config.yaml")).andStubReturn(configBinaryResultMock);
  ...
  public void downstreamBranchesTest_resourceNotFoundException() throws Exception {
    expect(projectApiMock.branch("asdfidontexist")).andThrow(new ResourceNotFoundException("Oh no."));
    loadConfig();
    Set<String> expectedBranches = new HashSet<String>();
    assertThat(configLoader.getDownstreamBranches(
  ...
  public void downstreamBranchesTest_restApiException() throws Exception {
    expect(branchApiMock.file("default.xml")).andThrow(new RestApiException("Oh no."));
    loadConfig();
    Set<String> expectedBranches = new HashSet<String>();
