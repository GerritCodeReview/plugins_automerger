...
public class DownstreamCreatorIT extends LightweightPluginDaemonTest {
  ...
  public void testExpectedFlow() throws Exception {
    ...
    assertThat(getVote(masterChangeInfo.id, "Code-Review").value).isEqualTo(0);
    assertThat(getVote(masterChangeInfo.id, "Code-Review").tag).isEqualTo(null);
    ...
    // +2 and submit
    merge(result);
    assertThat(getVote(masterChangeInfo.id, "Code-Review").value).isEqualTo(2);
    assertThat(getVote(dsOneChangeInfo.id, "Code-Review").value).isEqualTo(2);
    assertThat(getVote(dsTwoChangeInfo.id, "Code-Review").value).isEqualTo(2);
  }
  ...
  public void testDiamondMerge() throws Exception {
    ...
    assertThat(getVote(bottomChangeInfoA.id, "Code-Review").value).isEqualTo(2);
    assertThat(getVote(bottomChangeInfoA.id, "Code-Review").tag)
    ...
    assertThat(getVote(bottomChangeInfoB.id, "Code-Review").value).isEqualTo(2);
    assertThat(getVote(bottomChangeInfoB.id, "Code-Review").tag)
        .isEqualTo("autogenerated:Automerger");

    ChangeInfo leftChangeInfo = sortedChanges.get(2);
    assertThat(leftChangeInfo.branch).isEqualTo("left");
    assertThat(getVote(leftChangeInfo.id, "Code-Review").value).isEqualTo(2);
    assertThat(getVote(leftChangeInfo.id, "Code-Review").tag).isEqualTo("autogenerated:Automerger");
    ...
    assertThat(getVote(rightChangeInfo.id, "Code-Review").value).isEqualTo(2);
    assertThat(getVote(rightChangeInfo.id, "Code-Review").tag)
        .isEqualTo("autogenerated:Automerger");
  ...
  public void testDiamondMerge_identicalDiamondSides() throws Exception {
    ...
    assertThat(getVote(bottomChangeInfo.id, "Code-Review").value).isEqualTo(2);
    assertThat(getVote(bottomChangeInfo.id, "Code-Review").tag)
        .isEqualTo("autogenerated:Automerger");
  ...
  public void testDownstreamMergeConflict() throws Exception {
    ...
    assertThat(getVote(dsTwoChangeInfo.id, "Code-Review").value).isEqualTo(-2);
    assertThat(getVote(dsTwoChangeInfo.id, "Code-Review").tag)
        .isEqualTo("autogenerated:Automerger");

    ChangeInfo masterChangeInfo = sortedChanges.get(1);
    assertThat(getVote(masterChangeInfo.id, "Code-Review").value).isEqualTo(-2);
    assertThat(getVote(masterChangeInfo.id, "Code-Review").tag)
        .isEqualTo("autogenerated:MergeConflict");
    assertThat(masterChangeInfo.branch).isEqualTo("master");
  ...
  public void testContextUser() throws Exception {
    ...
    ChangeInfo dsOneChangeInfo = sortedChanges.get(0);
    assertThat(dsOneChangeInfo.branch).isEqualTo("ds_one");
    assertThat(getVote(dsOneChangeInfo.id, "Code-Review").value).isEqualTo(0);

    // Try to +2 master and see it succeed to +2 master and ds_one
    ChangeInfo masterChangeInfo = sortedChanges.get(2);
    assertThat(masterChangeInfo.branch).isEqualTo("master");
    assertThat(getVote(masterChangeInfo.id, "Code-Review")).isNull();
  ...
  public void testContextUser_downstreamHighestVote() throws Exception {
    ...
    assertThat(getVote(masterChangeInfo.id, "Code-Review").value).isEqualTo(1);
    assertThat(getVote(dsOneChangeInfo.id, "Code-Review").value).isEqualTo(1);

    ChangeInfo dsTwoChangeInfo = sortedChanges.get(1);
    assertThat(dsTwoChangeInfo.branch).isEqualTo("ds_two");
    assertThat(getVote(dsTwoChangeInfo.id, "Code-Review").value).isEqualTo(1);
