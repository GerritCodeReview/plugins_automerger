...
public class DownstreamCreatorIT extends PluginDaemonTest {
    ...
    public void testCreateDownstreamMerges() throws Exception {
        Map<String> downstreamBranchMap = new HashMap<String>();
        downstreamBranches.put("testone", false);
        downstreamBranches.put("testtwo", false);
    ...
    public void testCreateDownstreamMerges_withPreviousRevisions()
        ...
        Map<String, Boolean> downstreamBranchMap = new HashMap<String>();
