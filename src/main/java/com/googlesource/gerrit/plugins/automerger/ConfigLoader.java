...
public class ConfigLoader {
  ...
  private boolean getMergeAll(String fromBranch, String toBranch) throws ConfigInvalidException {
    return getConfig()
        .getBoolean("automerger", fromBranch + branchDelimiter + toBranch, "mergeAll", false);
  }
   ...
   * @throws ConfigInvalidException
   */
  public String getAutomergeLabel() throws IOException, RestApiException, ConfigInvalidException {
  ...
  private Set<String> getManifestProjects(String fromBranch, String toBranch)
    ...
    boolean ignoreSourceManifest =
        getConfig()
            .getBoolean(
                "automerger",
                fromBranch + branchDelimiter + toBranch,
