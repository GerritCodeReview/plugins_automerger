...
public class RemoteApi {
  private static final Logger log = LoggerFactory.getLogger(RemoteApi.class);
  private HttpHost host;
  private final CloseableHttpClient client;

  public RemoteApi(String url) {
  ...
  public HttpResponse getChange(String changeId) throws ClientProtocolException, IOException {
    String endPoint = Joiner.on("/").join(host, "a", "changes", changeId);
    return get(endPoint);
  }
