...
public class DownstreamCreator
   ...
   * @throws InvalidQueryParameterException Throws when we try to add an invalid value to the
   * query.
  ...
  private MultipleDownstreamMergeInput createMdsMergeInput(ChangeInfo change,
  ...
  private void propagateVotes(ChangeInfo change) throws RestApiException, OrmException, ConfigInvalidException, IOException {
    String revision = change.currentRevision;
    Set<String> downstreamBranches;
    downstreamBranches = config.getDownstreamBranches(change.branch, change.project);
