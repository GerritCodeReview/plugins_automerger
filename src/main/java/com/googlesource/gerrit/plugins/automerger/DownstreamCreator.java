 ...
 * upload a merge of the original patchset downstream, as determined by the configuration file.
 * When a topic or vote is changed on a patchset, or a change is abandoned, all downstream patchsets
