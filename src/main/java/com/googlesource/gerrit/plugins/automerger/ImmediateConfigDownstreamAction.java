...
class ImmediateConfigDownstreamAction
    implements RestModifyView<BranchResource, ImmediateConfigDownstreamAction.Input> {
   ...
   */
  @Inject
  public ImmediateConfigDownstreamAction(ConfigLoader config) {
    this.config = config;
  }
   ...
   */
  @Override
  public Response<Map<String, Boolean>> apply(BranchResource branchResource, Input input)
